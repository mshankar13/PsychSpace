    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="list-group">
                <a href="${contextPath}/${user.userKey}/settings" class="list-group-item active">Account Settings</a>
                <a href="${contextPath}/${user.userKey}/application" class="list-group-item">My Application</a>
            </div>
        </div>
        <div class="col-md-9">
